...
<div class="max-w-[1600px] mx-auto">
  ...
  ">
    ...
    <p class="p-4 text-center hidden md:block">
    ...
    <div class="flex justify-center gap-2">
      ...
      <a class="group flex flex-col items-center text-center p-2 hover:bg-gray-50/10" href="https://www.vestaboard.com/" rel="noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 group-hover:text-orange-400">
      ...
      <a class="group flex flex-col items-center text-center p-2 hover:bg-gray-50/10" href="https://werkenbij.infi.nl/" rel="noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 group-hover:text-orange-400">
      ...
      <a class="group flex flex-col items-center text-center p-2 hover:bg-gray-50/10" href="https://way.infi.nl/" rel="noreferrer">
        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="w-12 h-12 group-hover:text-orange-400">
